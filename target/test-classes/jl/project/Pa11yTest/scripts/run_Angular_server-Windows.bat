...
rem Workaround: to name a parent window, to start the angular server from that window, 
rem and to suppress the parent window with the option removing potential children processes as well. 
