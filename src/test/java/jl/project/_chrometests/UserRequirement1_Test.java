...
import jl.project.__commontests.TestsUtil;
...
public class UserRequirement1_Test {
	...
	public void setup() {	
		...
		TestsUtil.setup(logger,robot, StringExternalization.BROWSER_NAME_CHROME, driver, StringExternalization.WEBDRIVER_CHROME_KEY,StringExternalization.WEBDRIVER_CHROME_VALUE);
